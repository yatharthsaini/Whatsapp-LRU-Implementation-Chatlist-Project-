/**
 * Created by yatharthsaini 
 */

export { ChatHandler, chat_names}

const chat_names = ["Jose Mourinho", "Pep Guardiola", "Jurgen Klopp", "Graham Potter", "Antonio Conte", "Erik Ten Hag", "Mikel Arteta", "Xavi Hernandez", "Thomas Tuchel" , "Steven Gerrad" , "Frank Lampard", "Ole Gunnar Solsjkaer" ,"Carlo Ancelotti" , "Massimiliano allegri", "Patrick Veira", "David Moyes" , "Jesse Marsch", "Julian nagelsmann", "Diego Simeone"];
